...
KEY=IwbDvsMrSvEnc9MOCSdufSdetpZtIlLP
ENDPOINT_URL=http://b4f2d0d8-add4-44a2-b608-fdb665d31bd5.westeurope.azurecontainer.io/score

ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer $KEY' $ENDPOINT_URL
